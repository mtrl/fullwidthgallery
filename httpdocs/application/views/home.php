...
<div id="container">
    ...
    <?php foreach($photos as $month => $photos): ?>
        ...
        <div class="item">
            ...
            <?php endif; ?>
            <a class="fancybox" rel="group" href="<?php echo $photo->url ?>" title="<?php echo date('jS F Y', strtotime($photo->exif['date_time'])) ?> - <?php echo $photo->label ?>.<br><a href='<?php echo $photo->fullsize_url ?>' target='_blank'>Full size</a>">
